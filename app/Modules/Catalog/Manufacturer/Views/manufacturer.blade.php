  ...
  <div class="content-wrapper">
    <section class="content-header">
            <div class="container-fluid">
                <div class="pull-right"><a href="{{ route('AddManufacturer') }}" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                    <button type="button" data-toggle="tooltip" title="Delete" class="btn btn-danger" onclick="delete_manufacturer($ids)"><i class="fa fa-trash-o"></i></button>
                </div>
                <h1>Nhà sản xuất</h1>
                <ul class="breadcrumb">
...
<section class="content">
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <h3 class="panel-title"><i class="fa fa-list"></i> Danh sách nhà sản xuất</h3>
        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <td class="text-left"><a href="">Nhà sản xuất</a>
                                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditManufacturer', array(1))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteManufacturer',array(1))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditManufacturer', array(2))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteManufacturer',array(2))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditManufacturer', array(3))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>                                
                                <td class="text-right"><a href="{{ route('DeleteManufacturer', array(3))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditManufacturer', array(4))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteManufacturer', array(4))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
