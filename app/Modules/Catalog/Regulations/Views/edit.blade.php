                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="pull-right">
                            ...
                            <a href="{{ route('Regulations') }}" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a>
                        </div>
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="name" placeholder="Nhập Tên Nội Quy" value="{{$regulations->name}}" />
                            </div>                          
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="content">Nội dung</label>
                                <div class="col-sm-10 input-group">
                                <textarea name="content" value="{{ $regulations->content }}" placeholder="Nhập nội dung" id="content" data-toggle="summernote" data-lang="" class="form-control"></textarea>
                            </div>                                                  
                            <div >
