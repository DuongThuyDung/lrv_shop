               ...
               <div class="container-fluid">
                  <div class="pull-right">
                     <button type="submit" data-toggle="tooltip" title="Save" class="btn btn-primary"><i class="fa fa-save"></i></button>
                        <a href="{{ route('GroupNew') }}" data-toggle="tooltip" title="Cancel" class="btn btn-default">
                  ...
                  <ul class="breadcrumb">
                     ...
                     <li><a href="{{ route('GroupNew') }}">Nội Quy-Quy định</a></li>
                  </ul>
               </div>
            </section>
               ...
               <div>
                  ...
                  <form action="" method="POST">
                     <input type="hidden" name="_token" value="{{csrf_token()}}" />
                        ...
                        <div class="form-group">
                           <label>Tên Nội Quy</label>
                           <input class="form-control" name="name" placeholder="Nhập Tên Nội Quy" />
                        </div>
                        <div class="form-group">
                           <label>Nội Dung</label>
                           <div class="col-sm-10 input-group">
                              <textarea name="content" placeholder="Nhập Nội Dung" id="content" data-toggle="summernote" data-lang="" class="form-control ckeditor"></textarea>
                           </div><br>
                        </div>
