...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
          <div class="pull-right">
            ...
            <a href="{{ route('AttributeGroup') }}" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a>
          </div>
          <h1>Products</h1>
          <ul class="breadcrumb">
              <li><a href="{{ route('Dashboard') }}">Home</a></li>
              <li><a href="{{ route('AttributeGroup') }}">Attributes Group</a></li>
          </ul>
        </div>
    </section>
    <!-- Main content -->
    ...
    <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Thêm mới nhóm thuộc tính</h3>
            </div>
            <div class="panel-body">
              <div id="General" class="tab-pane fade in active">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="attribute_group">Tên nhóm thuộc tính</label>
                        <div class="col-sm-10 input-group">
                            <input type="text" name="attribute_group" value="" placeholder="Tên nhóm thuộc tính" id="attribute_group" class="form-control"/>
                        </div>
                    </div>
