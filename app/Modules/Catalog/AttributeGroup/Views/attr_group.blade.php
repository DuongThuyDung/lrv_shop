  ...
  <div class="content-wrapper">
    <section class="content-header">
            <div class="container-fluid">
                <div class="pull-right"><a href="{{ route('AddAttributeGroup') }}" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                    <button type="button" data-toggle="tooltip" title="Delete" class="btn btn-danger" onclick="delete_attribute_group($ids)"><i class="fa fa-trash-o"></i></button>
                </div>
                <h1>Nhóm thuộc tính</h1>
                <ul class="breadcrumb">
                    <li><a href="{{ route('Dashboard') }}">Home</a></li>
                    <li><a href="{{ route('AttributeGroup') }}">Attribute Groups</a></li>
                </ul>
            </div>
    </section>
    <!-- Main content -->
<section class="content">
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <h3 class="panel-title"><i class="fa fa-list"></i> Danh sách nhóm thuộc tính</h3>
        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <td class="text-left"><a href="">Tên nhóm</a>
                                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditAttributeGroup', array(1))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteAttributeGroup',array(1))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditAttributeGroup', array(2))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteAttributeGroup',array(2))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditAttributeGroup', array(3))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>                                
                                <td class="text-right"><a href="{{ route('DeleteAttributeGroup', array(3))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditAttributeGroup', array(4))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteAttributeGroup', array(4))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
