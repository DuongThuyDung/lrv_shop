  ...
  <div class="content-wrapper">
    <section class="content-header">
            <div class="container-fluid">
                <div class="pull-right"><a href="{{ route('AddAttribute') }}" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                    <button type="button" data-toggle="tooltip" title="Delete" class="btn btn-danger" onclick="delete_attribute($ids)"><i class="fa fa-trash-o"></i></button>
                </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <h3 class="panel-title"><i class="fa fa-list"></i> Danh sách thuộc tính</h3>
        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <td class="text-left"><a href="">Tên thuộc tính</a>
                                </td>
                                <td class="text-left"><a href="">Giá trị</a>
                                </td>
                                <td class="text-left"><a href="">Nhóm thuộc tính</a>
                                </td>
                                <td class="text-right"><a href="">Thứ tự</a>
                                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditAttribute', array(1))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteAttribute',array(1))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditAttribute', array(2))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteAttribute',array(2))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                <td class="text-center"><input type="checkbox" name="selected[]" value="6" />
                                </td>
                                <td class="text-left">Intel Core i7</td>
                                <td class="text-left">Intel Core i7</td>
                                <td class="text-left">Processor</td>
                                <td class="text-right">3</td>
                                <td class="text-right"><a href="{{ route('EditAttribute', array(3))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>                                
                                <td class="text-right"><a href="{{ route('DeleteAttribute', array(3))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-right"><a href="{{ route('EditAttribute', array(4))}} " data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                <td class="text-right"><a href="{{ route('DeleteAttribute', array(4))}} " data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
