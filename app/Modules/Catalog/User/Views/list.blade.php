  ...
  <div class="content-wrapper">
    <section class="content-header">
            <div class="container-fluid">
                <div class="pull-right"><a href="{{ route('AddUser') }}" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                    <button type="button" data-toggle="tooltip" title="Delete" class="btn btn-danger" onclick="delete_Users($ids)"><i class="fa fa-trash-o"></i></button>
                </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="panel panel-default">
            ...
            <h3 class="panel-title"><i class="fa fa-list"></i> Danh sách người dùng </h3>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        <thead>
                          <tr>
                            <td>STT</td>
                            <td class="text-left"><a href="">Họ và tên</a></td>
                            <td class="text-left"><a href="">email</a></td>
                            <td class="text-left"><a href="">loại tài khoản</a></td>
                        ...
                        @foreach($user as $cat)
                          <tr>
                            ...
                            <td  class="text-right">
                              <a href="{{ route('EditUser',['id'=>$cat->id]) }}" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i></a>
                            </td>
                            <td  class="text-right">
                              <a href="{{ route('DeleteUser',['id'=>$cat->id]) }}" class="btn btn-default btn-xs" onclick="return confirm('Bạn có chắc không?')">
