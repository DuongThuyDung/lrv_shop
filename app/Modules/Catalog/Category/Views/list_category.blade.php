 ...
 <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
       <div class="pull-right"><a href="{{ route('AddCategory') }}" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
 ...
 <div class="container-fluid">
  <div class="panel panel-default">
   <div class="panel-heading">
      <h3 class="panel-title"><i class="fa fa-list"></i> Danh Sách Thể Loại</h3>
   </div>
   @if(session('thongbao'))
   ...
   <form action="" method="post" enctype="multipart/form-data">
    <div class="table-responsive">
     <table class="table table-bordered table-hover">
      <thead>
        <tr>
          <td>STT</td>
          <td class="text-left"><a href="">Tên Thể Loại</a></td>
    ...
    <tbody>
      ...
      <tr>
       ...
       <td>{{$cat->slug}}</td>
       <td  class="text-right">
         <a href="{{ route('EditCategory',['id'=>$cat->id]) }}" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i></a>
      </td>
      <td  class="text-right">
         <a href="{{ route('DeleteCategory',['id'=>$cat->id]) }}" class="btn btn-danger btn-xs" onclick="return confirm('Bạn có chắc không?')">
...
<div class="row">
  ...
  <div class="col-sm-6 text-right"> (1 Pages)</div>
</div>
</div>
</div>  
</section>
