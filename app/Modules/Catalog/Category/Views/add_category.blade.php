<h1>Đây là trang thêm danh mục</h1>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
          <div class="pull-right">
            ...
            <a href="{{ route('Attribute') }}" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a>
          </div>
          <h1>Products</h1>
          <ul class="breadcrumb">
    ...
    <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Thêm mới thuộc tính</h3>
            </div>
            <div class="panel-body">
              <div id="General" class="tab-pane fade in active">
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="attribute_name">Tên thuộc tính</label>
                        <div class="col-sm-10 input-group">
                            <input type="text" name="attribute_name" value="" placeholder="Tên thuộc tính" id="attribute_name" class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group required">
                            <label class="col-sm-2 control-label" for="attribute_value">Tên thuộc tính</label>
                            <div class="col-sm-10 input-group">
                                <input type="text" name="attribute_value" value="" placeholder="Giá trị thuộc tính" id="attribute_value" class="form-control"/>
                            </div>
                    </div>
                    <div class="form-group">
                            <label class="col-sm-2 control-label" for="attribute_group_id"><span data-toggle="tooltip" title="(Autocomplete)">Nhóm thuộc tính</span></label>
                            <div class="col-sm-10 input-group">
                              <input type="text" name="attribute_group_id" value="" placeholder="Nhóm thuộc tính" id="attribute_group_id" class="form-control"/>                            </div>
                    </div>
                    <div class="form-group">
